...
const deleteFromIncompleteList = (target) => {
  // target.remove(); // →直接DOMを削除する remove()はIEで非対応
...
const createIncompleteList = (text) => {
  ...
  li.innerText = text;
  li.className = "list-layout";

  // button(完了)タグ生成
  const completeButton = document.createElement("button");
  completeButton.innerText = "完了";
  completeButton.className = "default_button";
  completeButton.addEventListener("click", () => {
    ...
    backButton.className = "default_button";
  ...
  deleteButton.className = "default_button";
